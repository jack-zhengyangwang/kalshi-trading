...
- [ ] Renders from `metrics.json` alone, with no live API calls
- [ ] Out-of-sample shown by default, in-sample explicitly labelled
- [ ] Calibration plot with the reference diagonal
- [ ] Leaderboard over a common window
- [ ] Readable on a phone
