...
from wc.lib.exit_rules import decide_exit, disarm  # noqa: F401 (re-exported)
...
def perturb(params, rng):
    """PBT 'explore': a small in-place mutation of a surviving team's own params,
    so survivors keep drifting toward better settings instead of staying frozen."""
